              ...
              {viewingClaim.status === 'Pending' && (
                <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200">
                  ...
                  <div className="flex gap-6">
                    ...
                    <button
                      onClick={async () => {
                        await handleDeleteClaim(viewingClaim._id);
                        setViewingClaim(null);
                      }}
                      disabled={processing}
                      className="flex items-center justify-center gap-3 px-8 py-4 bg-gray-800 text-white rounded-xl hover:bg-gray-900 transition-all font-semibold text-lg shadow-md hover:shadow-lg active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
