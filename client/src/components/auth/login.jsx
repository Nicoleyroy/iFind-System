          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="relative flex justify-center my-4">
              {error && error.includes("reCAPTCHA") && (
                <div className="absolute -top-3 left-4 sm:left-8 bg-orange-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold z-10">!</div>
              )}
